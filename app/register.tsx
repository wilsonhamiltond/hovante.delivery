...
> = {
  ...
  fr: {
    steps: ['E-mail', 'Code', 'Compte', 'Mot de passe', 'Adresse'],
    ...
    enterFullName: 'Saisissez votre prénom et votre nom.',
    writeFullName: 'Écrivez votre prénom et votre nom.',
    ...
    writeAddressLabel: 'Écrivez le nom de votre adresse.',
    pickOnMap: 'Choisissez votre position sur la carte.',
    step1Lead: 'Commençons par votre e-mail. Nous vous enverrons un code pour le vérifier.',
    emailLabel: 'Adresse e-mail',
    emailPlaceholder: 'vous@exemple.com',
    step2Lead: (email) => `Saisissez le code à 6 chiffres que nous avons envoyé à ${email}.`,
    resendPrompt: 'Rien reçu ? Renvoyer le code',
    step3Lead: 'Dites-nous qui vous êtes et comment vous contacter.',
    nameLabel: 'Prénom et nom',
    namePlaceholder: 'Anne Dupont',
    phoneLabel: 'Téléphone',
    step4Lead: 'Protégez votre compte. Saisissez le même mot de passe deux fois.',
    passwordLabel: 'Mot de passe',
    passwordPlaceholder: 'Au moins 7 caractères',
    confirmLabel: 'Confirmer le mot de passe',
    confirmPlaceholder: 'Saisissez à nouveau votre mot de passe',
    addressNameLabel: "Nom de l'adresse",
    customLabelPlaceholder: 'Ex. Maison de maman',
