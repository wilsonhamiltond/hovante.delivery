...
> = {
  ...
  fr: {
    localeLabel: (code) =>
      code === 'en' ? 'Anglais (en)' : code === 'fr' ? 'Français (fr)' : code,
    trNameRequired: 'Le nom traduit est requis.',
    cameraPermTitle: 'Autorisation d’appareil photo',
    cameraPermBody: 'Activez l’autorisation d’appareil photo pour prendre la photo du produit.',
    photoPermTitle: 'Autorisation de photos',
    photoPermBody: 'Activez l’autorisation de photos pour ajouter une image.',
    photoSourceTitle: 'Photo du produit',
    photoSourceBody: 'D’où la prenons-nous ?',
    camera: 'Appareil photo',
    gallery: 'Galerie',
    cancel: 'Annuler',
    nameRequired: 'Le nom est requis.',
    priceInvalid: 'Saisissez un prix valide.',
    savedButImageFailed: (message) => `Le produit a été enregistré, mais pas l’image : ${message}`,
    ...
    uploadOnSave: 'Sera envoyée à l’enregistrement',
    photoHintWeb: 'Carrée, c’est ce que voient les clients',
    photoHint: 'Appareil photo ou galerie · carrée, c’est ce que voient les clients',
    name: 'Nom',
    namePlaceholder: 'Ex. : Bière Presidente 650 ml',
    description: 'Description (facultative)',
    descriptionPlaceholder: 'Ex. : Bouteille fraîche, 650 ml',
    price: 'Prix (RD$)',
    category: 'Catégorie',
    categoryPlaceholder: 'Sélectionner une catégorie',
    categorySearch: 'Rechercher une catégorie…',
    categoryClear: 'Retirer la catégorie (automatique)',
    categoryEmpty: 'Aucune catégorie ne correspond.',
    forSale: 'En vente',
    forSaleOn: 'Les clients peuvent le commander',
    forSaleOff: 'N’apparaît pas sur le marché',
    translations: 'Traductions',
    addTranslation: '+ Ajouter',
    saveFirst: 'Enregistrez d’abord le produit pour ajouter des traductions.',
    noTranslations: 'Aucune traduction. Le nom et la description ci-dessus sont la version en espagnol ; utilisez « + Ajouter » pour l’anglais ou le français.',
    editTranslation: (locale) => `Modifier la traduction (${locale})`,
    newTranslation: 'Nouvelle traduction',
    language: 'Langue',
    trNamePlaceholder: 'Ex. : Presidente beer 650ml',
    trDescriptionPlaceholder: 'Ex. : Cold bottle, 650 ml',
