...
> = {
  ...
  fr: {
    back: 'Compte',
    title: 'Catégories',
    hint: 'Les catégories de produits de votre commerce. Les générales sont partagées par toute l’application.',
    newBtn: '+ Nouvelle',
    empty: 'Votre commerce n’a pas encore de catégories propres. Touchez « + Nouvelle » pour créer la première.',
    shared: 'Générale',
    newCategory: 'Nouvelle catégorie',
    name: 'Nom',
    namePlaceholder: 'Ex. : Boissons fraîches',
    ...
    photoSourceTitle: 'Image de la catégorie',
    photoSourceBody: 'D’où la prenons-nous ?',
    camera: 'Appareil photo',
    gallery: 'Galerie',
    cameraPermTitle: 'Autorisation d’appareil photo',
    cameraPermBody: 'Activez l’autorisation d’appareil photo pour prendre la photo de la catégorie.',
    photoPermTitle: 'Autorisation de photos',
    photoPermBody: 'Activez l’autorisation de photos pour ajouter une image.',
    createdButImageFailed: (message) => `La catégorie a été créée, mais pas l’image : ${message}`,
    ...
    updatedButImageFailed: (message) => `Les modifications ont été enregistrées, mais pas l’image : ${message}`,
    delete: 'Supprimer la catégorie',
    deleteConfirm: 'Sûr ? Touchez de nouveau pour supprimer',
