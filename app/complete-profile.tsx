...
> = {
  ...
  fr: {
    steps: ['Informations', 'Localisation'],
    ...
    knownNameLead: (name) => `Bonjour, ${name}. Votre nom et votre e-mail proviennent déjà de votre compte. Il ne manque qu’un téléphone de contact.`,
    verifiedLead: 'Votre compte est déjà vérifié. Il ne manque qu’un téléphone de contact.',
    phoneLabel: 'Téléphone',
    notNow: 'Pas maintenant, je veux explorer',
    ...
    addressFieldPlaceholder: 'Se remplit en choisissant sur la carte',
    finish: 'Terminer',
