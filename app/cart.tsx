...
> = {
  ...
  fr: {
    ...
    emptySubtitle: 'Ajoutez des produits de vos commerces favoris et vous les verrez ici.',
    exploreMerchants: 'Explorer les commerces',
    branch: 'Succursale',
    branchLead: 'Plusieurs succursales livrent à votre adresse. Choisissez celle d’où vous voulez votre commande.',
    continueLabel: 'Continuer',
    deliveryMode: 'Mode de livraison',
    deliveryTitle: 'Livraison',
    deliverySub: 'Nous vous l’apportons à votre adresse',
    pickupTitle: 'Retrait en magasin',
    pickupSub: 'Vous le récupérez au commerce · sans frais de livraison',
    paymentMethod: 'Moyen de paiement',
    cashTitle: 'Espèces',
    cashSub: 'Vous payez à la réception de votre commande',
    cardTitle: 'Carte de crédit',
    cardSub: 'Très bientôt',
    comingSoon: 'Prochainement',
    tapInsideArea: 'Touchez à l’intérieur de la zone délimitée pour choisir où livrer',
    tapMap: 'Touchez la carte pour choisir où livrer',
    myLocation: '📍 Ma position',
    theMerchant: 'Le commerce',
    moreBranches: (n) => ` et ${n} succursale(s) de plus`,
    deliveryAddress: 'Adresse de livraison',
    thisMerchant: 'ce commerce',
    outsideWarn: (name) => `Ce point est en dehors de la zone de livraison de ${name}. Choisissez-en un à l’intérieur de la zone.`,
    outsideTitle: 'Hors de la zone de livraison',
    outsideBody: 'Ce commerce ne livre qu’à l’intérieur de la zone délimitée sur la carte. Choisissez un point à l’intérieur de la zone.',
    ...
    orderFailedTitle: 'La commande n’a pas pu être créée',
    notesLabel: 'Notes pour le commerce',
    notesPlaceholder: 'Ex. : sans oignon, sonner à la porte…',
    payWithLabel: 'Avec combien allez-vous payer ?',
    payWithPlaceholder: (total) => `Ex. : 1000 · total ${total} · vide si vous payez le montant exact`,
    payWithError: (total) => `Le montant doit couvrir le total de la commande (${total}).`,
    changeDue: (amount) => `Votre monnaie : ${amount}`,
    detailsLabel: 'Détails',
    cashPaymentSuffix: ' · Paiement en espèces',
    payingWithSuffix: (pay, change) => ` · Vous payez avec ${pay} · monnaie ${change}`,
    deliverAt: 'Livrer à',
    pickUpAt: 'Retirer à',
    noAddress: 'Aucune adresse',
    etaFrom: (eta, name) => `⏱️ ${eta} depuis ${name}`,
    fromMerchantFallback: 'le commerce',
    productsAt: (name) => `Produits · ${name}`,
    shippingLabel: 'Frais de livraison',
    pickupNoShipping: 'Retrait en magasin · sans frais de livraison',
    homeDelivery: (eta) => `Livraison à domicile · ${eta}`,
