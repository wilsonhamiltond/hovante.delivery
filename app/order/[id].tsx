...
> = {
  ...
  fr: {
    stages: [
      { title: 'Commande passée', sub: 'Le commerce a reçu votre commande' },
      { title: 'Commande confirmée', sub: 'Le commerce a accepté votre commande' },
      { title: 'Prête à récupérer', sub: 'Le commerce a préparé votre commande' },
      { title: 'Livreur assigné', sub: 'Un livreur a pris votre commande' },
      { title: 'En route', sub: 'Votre commande arrive vers vous' },
      { title: 'Livrée', sub: 'Profitez de votre commande' },
    ],
    headlines: [
    ...
    pickupStages: [
      { title: 'Commande passée', sub: 'Le commerce a reçu votre commande' },
      { title: 'Commande confirmée', sub: 'Le commerce a accepté votre commande' },
      { title: 'Prête à récupérer', sub: 'Passez la chercher au commerce' },
      { title: 'Livrée', sub: 'Profitez de votre commande' },
    ],
    pickupHeadlines: [
      'En attente de confirmation du commerce…',
    ...
    trackingTitle: 'Suivi',
    cancelledHeadline: 'Commande annulée',
    failedHeadline: 'Livraison échouée',
    returnedHeadline: 'Commande retournée',
    queueNote: (min) => `Le commerce commencera à la préparer dans environ ${min} min. Vous pouvez l'annuler d'ici là.`,
    driverLine: (name) => `Livreur : ${name}`,
    codeLabel: 'Code de livraison',
    codeHintPickup: 'Montrez-le au commerce en récupérant votre commande',
    codeHintDelivery: 'Donnez-le au livreur à la réception de votre commande',
    merchantLabel: 'Commerce',
    deliverAt: 'Livrer à',
    pickUpAt: 'Récupérer à',
    merchantFallback: 'Le commerce',
    merchantTitleFallback: 'Commerce',
