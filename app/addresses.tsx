...
const styles = StyleSheet.create({
  ...
  empty: { color: '#6b7280', fontSize: 14, textAlign: 'center', marginTop: 40, paddingHorizontal: 24 },
  card: { flexDirection: 'row', gap: 12, backgroundColor: '#fff', borderRadius: 12, padding: 14, alignItems: 'flex-start' },
  pin: { fontSize: 18 },
