...
> = {
  ...
  fr: {
    ...
    assigned: 'Un livreur a pris votre commande.',
    delivered: 'Votre commande a été livrée !',
    failed: 'La livraison n’a pas pu être effectuée.',
    returned: 'Votre commande a été retournée au commerce.',
    cancelled: 'Votre commande a été annulée.',
    pending: 'En attente de la confirmation du commerce.',
    confirmed: 'Le commerce a accepté votre commande.',
    preparing: 'Le commerce prépare votre commande.',
    readyPickup: 'Votre commande est prête à retirer.',
    readyFindingDriver: 'Votre commande est prête, recherche d’un livreur.',
    changed: 'Votre commande a changé de statut.',
    yourOrder: 'Votre commande',
    driverDelivered: 'Livraison terminée.',
    driverInTransit: 'Vous êtes en route vers le client.',
    driverAssigned: 'Vous avez pris cette livraison. Passez la récupérer.',
    driverPending: 'Livraison assignée, en attente de récupération.',
    driverFailed: 'Cette livraison a été marquée comme échouée.',
    driverReturned: 'Commande retournée au commerce.',
    driverCancelled: 'Cette livraison a été annulée.',
    driverChanged: 'Cette livraison a changé de statut.',
    deliveryFallback: 'Livraison',
    clientFallback: 'Client',
    merchantAssigned: 'Un livreur vient la récupérer.',
    merchantInTransit: 'Le livreur est parti avec la commande.',
    merchantDelivered: 'Livrée au client.',
    merchantFailed: 'La livraison a échoué.',
    merchantReturned: 'La commande a été retournée.',
    merchantCancelled: 'Le client a annulé cette commande.',
    merchantPending: 'Nouvelle commande ! Confirmez-la pour commencer.',
    merchantConfirmed: 'Confirmée. Préparez-la quand vous pouvez.',
    merchantPreparing: 'En préparation.',
    merchantReadyPickup: 'Prête. Le client vient la récupérer.',
    merchantReadyDriver: 'Prête. En attente d’un livreur.',
    merchantChanged: 'Cette commande a changé de statut.',
  },
};
